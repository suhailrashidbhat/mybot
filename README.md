...
mobi-bot is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.
...
### Running mobi-bot Locally

You can test your hubot by running the following.

You can start mobi-bot locally by running:
...
Then you can interact with mobi-bot by typing `mobi-bot help`.

    mobi-bot> mobi-bot help

    mobi-bot> animate me <query> - The same thing as `image me`, except adds a few
